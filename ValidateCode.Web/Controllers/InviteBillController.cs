...
namespace ValidateCode.Web.Controllers
{
    ...
    /// </summary>
    [LoginFilter]
    public class InviteBillController : BaseController
    {
        ...
        {
            return JResult(IInviteBillService.GetPageList(pageIndex, pageSize, name, createdTimeStart, createdTimeEnd, this.LoginUser.ID));
        }
    }
}